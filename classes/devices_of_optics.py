...
class DevicesOfOptics(Device):
    def __init__(self, price: float, material: Matherial, origin_country: Country,
                 category: Equipment, weight_in_grams: int, device_type: DeviceType, lens: str):
    ...
    def __str__(self):
        return super(DevicesOfOptics, self).__str__() + f'Lens: {self.lens}\n'
